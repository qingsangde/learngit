...
{
    public class sta_DayTestDriveAnalyse_new
    {
            ...
            )
        {
            ...
            DataTable dt = csh.FillDataSet(sysflag, WebProc.Proc("X80Proc_DayAnalyse_List_Select_New"), Parameters, null, 1800).Tables[0];
            ...
            {
                int d =Int32.Parse(dt.Rows[i]["DDay"].ToString().Trim());
            ...
            //SumXDXS = Math.Round(SumJZ / SumYZ, 2);//新度系数的计算 原值/净值
        ...
        public ResponseResult getSFCaroutput(Dictionary<string, string> inparams)
        {
            ...
            try
            {
                ...
                string[] headerDataArray = { "时间/日期", "合计", "1日", "2日", "3日", "4日" , "5日", "6日", "7日", "8日" , "9日",
