        ...
        if (obj.state == 100) {
            ...
            $('#ff').combogrid({
                onClickRow: function (rowIndex, rowData) {
                    ...
                    selLineId = rowData.L_ID;
                    $('#spanLname')[0].innerHTML = rowData.L_Name;
                    $('#spanDealerName')[0].innerHTML = rowData.DEALERNAME;
                    $("#spanFence").show();
                    $("#divFilter").hide();
                    InitGraphAndCarList(rowData);
                }
            });
        }
        else {
...
function InitGraphAndCarList(rowData) {
    var mydata = {
