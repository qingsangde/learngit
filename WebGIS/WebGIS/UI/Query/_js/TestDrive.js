...
function queryData_TD() {
   ...
   // }
    ...
    var mydata = { "sid": "sys-testdrive-search", "sysuid": UserCookie["UID"], "token": UserCookie["token"].toString(), "sysflag": UserCookie["sysflag"].toString(), "Page": "1", "Size": defultSize, "stime": STime, "etime": ETime, "cid": CID_sf };
...
function Export() {
    ...
    var mydata = { "sid": "sys-testdrive-search-output", "sysuid": UserCookie["UID"], "token": UserCookie["token"].toString(), "sysflag": UserCookie["sysflag"].toString(), "Page": "1", "Size": defultSize, "stime": STime, "etime": ETime, "cid": CID_sf };
    ExcelExport(mydata);
}
