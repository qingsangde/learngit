...
$(function () {
    ...
    $("#SYear").combobox('setValue', year);


    $("#SMonth").combobox('setValue', month);
...
function queryData_Sf() {
    ...
    var STime = $('#SYear').combobox('getValue').trim() + "-" + $('#SMonth').combobox('getValue').trim();
    ...
    var mydata = { "sid": "DayTestDriveAnalyse-getlist-new", "sysuid": UserCookie["UID"], "token": UserCookie["token"].toString(), "sysflag": UserCookie["sysflag"].toString(),
...
function Export() {
    ...
    var mydata = { "sid": "DayTestDriveAnalyse-getlist-new-output", "sysuid": UserCookie["UID"], "token": UserCookie["token"].toString(), "sysflag": UserCookie["sysflag"].toString(),
